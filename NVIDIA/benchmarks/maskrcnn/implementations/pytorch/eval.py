...
CMD="ssh ubuntu@{} \
        ...
        && python3 -u -m bind_launch --nnodes 4 --node_rank {} --master_addr 192.168.93.206 --master_port 1234 \
        --nsockets_per_node=2 \
        ...
        OUTPUT_DIR '/shared/gautam/checkpoints_32_epoch17_bs512_1_' \
        DISABLE_REDUCED_LOGGING True \
        TEST.IMS_PER_BATCH 512 \
        NHWC True \
        DATALOADER.NUM_WORKERS 4 \
        &> /shared/gautam/checkpoints_32_epoch17_bs512_1_/eval_4node_log5\""
